...
#ifndef _ADAFRUIT_2801MATRIX_H_
#define _ADAFRUIT_2801MATRIX_H_
...
class Adafruit_2801Matrix : public Adafruit_GFX, public Adafruit_WS2801 {

 public:

  // Constructor for single matrix:
  Adafruit_2801Matrix(int w, int h, uint8_t pin1 = 2, uint8_t pin2 = 3,
    uint8_t matrixType = NEO_MATRIX_TOP + NEO_MATRIX_LEFT + NEO_MATRIX_ROWS,
    uint8_t ledType    = WS2801_RGB);

  // Constructor for tiled matrices:
  Adafruit_2801Matrix(uint8_t matrixW, uint8_t matrixH, uint8_t tX,
    uint8_t tY, uint8_t pin1 = 2, uint8_t pin2 = 2,
    uint8_t matrixType = NEO_MATRIX_TOP + NEO_MATRIX_LEFT + NEO_MATRIX_ROWS +
